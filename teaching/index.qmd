...
This course is required for Environmental Engineering majors. While we will use the [Julia programming language](https://julialang.org/) for computing, no prior experience with Julia is required.
...
- Spring 2024 (with [Christine Goodale](https://ecologyandevolution.cornell.edu/christine-l-goodale), [Angeline Pendergrass](https://precipclimate.eas.cornell.edu/), and [Jeremy Wallace](https://jeremywallace.org/))
